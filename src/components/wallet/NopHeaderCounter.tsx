  ...
  const nopBalance = useWalletStore((state) => state.nop);
    ...
    return (
      <button
        ...
        className={cn(
          "inline-flex items-center gap-2 rounded-pill border border-border-subtle bg-card px-3.5 py-1.5",
      ...
      >
        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[var(--color-gold-chip)] text-[11px] font-bold text-slate-900 ring-2 ring-border-subtle/60">
          N
        </div>
